...
class ClientsPage extends PopUp{
    constructor(selenium){
        super(selenium)
    }
        ...
        try{
            ...
            // if there are one or more results- get all data about client(s) with the searched parameter (within all pages)                                    
                for (let c=1; c <= lastPage; c++) { 
                    ...
                    await this.selenium.clickElement("css", "#root > div > div.clients-component > div.page-numbers > img:nth-child(5)")  // click on "next" page arrow
        ...
        try{
            await this.selenium.clickElement("xpath", '//*[@id="root"]/div/div[4]/table/tr[2]/th[4]')           // click on the first client
                if(deleteClient === "delete") {
                    ...
                    await this.validatePopUp()                                                                  // Validate the pop up (should be: UPDATE SUCCESSFUL)
                ...
                if (updateClient === "update"){
                    if(country) {
                        ...
                        // // Validate the name of the country was changed
                        // let countryName = await this.selenium.getTextFromElement("css", "tr.clientDetails th:nth-child(3)") // get the text of the country
                        //     if(countryName === country) {
                        //         console.log(`The country name was updated successfuly: ${country}`)
                        //     }     
                        //     else {
                        //         console.log(`The country name wasn't changed`)
                        //     }
                    }
                    if(email) {
                        ...
                        // //validate the email was changed
                        // let emailText = await this.selenium.getTextFromElement("css", 'tr.clientDetails th:nth-child(4)')     // get the text of the email
                        //     if(emailText === email) {
                        //         console.log(`The email was updated successfuly: ${email}`)
                        //     }
                        //     else {
                        //         console.log(`The email wasn't changed`)
                        //     }
                    }
            }
        } catch(error) {
